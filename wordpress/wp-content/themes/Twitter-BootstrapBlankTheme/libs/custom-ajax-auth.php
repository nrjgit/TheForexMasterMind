...
if(isset($_POST['saveFBUserinfo'])) {
	
     $data    = $_POST["saveFBUserinfo"];
     $data    = json_decode("$data", true);

	
     $info = array();
  	 $info['user_nicename'] = $info['nickname'] = $info['display_name'] = $info['first_name'] = $info['user_login'] = $data["username"] ;
...
if(isset($_POST['saveFBUserinfo1'])) {
...
// echo '<script type="text/javascript">alert(" database saved")</script>';
