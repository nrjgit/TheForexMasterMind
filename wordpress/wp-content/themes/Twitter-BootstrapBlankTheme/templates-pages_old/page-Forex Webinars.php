<?php /* Template Name: Forex Webinars*/ ?>

<?php get_header(); ?>
<div class="main">
  <div class="jumbotron jumbotron14" style="background-image: url('../../wp-content/uploads/2015/10/jumbotron14.jpg');">
    <div class="container">
      <div class="jumbotron-block pull-right">
        <div class="jumbotron-block__title">Forex Webinars</div>
        <span class="jumbotron-block__text">
          <span class="jumbotron-block__text">investorz Forex present you probably the best Forex education platform. To join a Forex webinar, please select the type you are interested and press FIND. You will be provided with&nbsp;the list of Forex webinars based on your search results.</span>        </span>
            ...
            <div class="form-row">
              <div class="form-col">
                    ...
                    <option value="all">All</option>
                                          ...
                                          <option value="for-traders">For Traders</option>
                                          <option value="fx-brokers">FX Brokers</option>
                                      </select>
                              </div>
              <div class="form-col">
                <input type="submit" class="btn btn-danger btn-lm" value="find">
              </div>
            </div>
          </form>
        </div>
        <a href="../about/contact-us/index.html" class="help-link"><i class="icon-sprite icon-arrow-green"></i>Contact Help</a>
      </div>
  ...
  <div class="webinar-calendar">
    <div class="container">
      <div class="row">
        <div class="webinar-calendar__title">Calendar of Events</div>
        <div class="webinar-item">
          <div class="webinar-item__inner">
            <div class="webinar-item__img">
              <span></span>
              <!-- <img src="http://investorz.com/verstka/images/webinar-img1.png" alt="" /> -->
            </div>
            <div class="webinar-item__title">ADD THIS TO YOUR PERSONAL CALENDAR</div>
            <div class="webinar-item__form zNice">
              <form>
                <div>
                  <input name="instructions_name" placeholder="Your Name" class="whiteInput" type="text">
                </div>
                <div>
                  <input name="instructions_email" placeholder="yoremail@gmail.com" class="whiteInput" required="required" type="email">
                </div>
                <div>
                  <input type="submit" value="get instructions" class="btn btn-lm btn-danger" id="get-webinar-instructions">
                </div>
              </form>
            </div>
          </div>
        </div>
        <div class="webinar-item hidden-xs">
          <div class="webinar-item__inner">
            <div class="webinar-item__img">
              <span></span>
              <!-- <img src="http://investorz.com/verstka/images/webinar-img2.png" alt="" /> -->
            </div>
            <div class="webinar-item__title">Daily Webinars</div>
            <div class="webinar-item__text">
                              While the market has too much of noise, retail traders often need guidance. In this session we will have two professional traders discussing Forex market                           </div>
                          <a href="../../external.html?link=https://attendee.gotowebinar.com/register/7012051120144325122" class="btn btn-lm btn-primary" target="_blank">JOIN THIS EVENT</a>
                                                  <a href="how-to-spot-market-reversals/index.html" class="btn btn-lm btn-danger" style="margin-top: 10px">JOIN NEXT EVENT</a>
                      </div>
        </div>
        <div class="webinar-item hidden-xs">
          <div class="webinar-item__inner">
            <div class="webinar-item__img">
              <span></span>
              <!-- <img src="http://investorz.com/verstka/images/webinar-img3.png" alt="" /> -->
            </div>
            <div class="webinar-item__title">FEATURED EVENTS</div>
            <div class="webinar-item__events">
                                                <div>
                    <span>
                      <a href="how-to-spot-market-reversals/index.html">
                        <span class="moment-convert-timezone" data-gmt-date="2016-10-03T15:00:00+00:00"></span>
                      </a>
                    </span>
                    <span>How to Spot Market Reversals 2.0</span>
                  </div>
                                  <div>
                    <span>
                      <a href="forex-news-trading-strategy/index.html">
                        <span class="moment-convert-timezone" data-gmt-date="2016-08-09T14:00:00+00:00"></span>
                      </a>
                    </span>
                    <span>Forex News Trading Strategy</span>
                  </div>
                                          </div>
            <span class="webinar-little"><a href="#" data-toggle="modal" data-target="#changeTimeZone" class="current-timezone-desc">Events are listed in your local time</a></span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="webinar">
      <div class="webinar-heading nopadding">
        <div class="colum">
          <div class="webinar-date">
            <span id="from-to-dates">AFTER AUGUST 31, 2016</span>
            <span><a href="#" class="current-timezone-desc" data-toggle="modal" data-target="#changeTimeZone">Events are listed in your local time</a></span>
          </div>
        </div>
        <div class="colum">
          <ul class="nav nav-tabs" id="myTab">
            <li class="active"><a href="#allupcoming" data-from-to-dates="AFTER AUGUST 31, 2016">ALL UPCOMING</a></li>
            <li><a href="#lastweek" data-from-to-dates="AUGUST 22 - 28, 2016">LAST WEEK</a></li>
            <li><a href="#thisweek" data-from-to-dates="AUGUST 29 - 4, 2016">THIS WEEK</a></li>
            <li><a href="#nextweek" data-from-to-dates="SEPTEMBER 5 - 11, 2016">NEXT WEEK</a></li>
          </ul>
        </div>
      </div>
      <div class="webinar-body">
        <div class="colum">
          <div class="tab-content">
            <div class="tab-pane active table-responsive" id="allupcoming">
              <div class="zTable">
                <form>
                  <table class="table">
                    <thead>
                ...
                <input type="submit" value="Add to Calendar" class="btn btn-lm btn-danger add-to-calendar" data-period="allupcoming">
              </div>
            </div>
            <div class="tab-pane table-responsive" id="lastweek">
              <div class="zTable">
                <form>
                  <table class="table">
                    <thead>
                ...
                <!-- <input type="submit" value="Add to Calendar" class="btn btn-lm btn-danger" />-->
              </div>
            </div>
            <div class="tab-pane table-responsive" id="thisweek">
              <div class="zTable">
                <form>
                  <table class="table">
                    <thead>
                ...
                <input type="submit" value="Add to Calendar" class="btn btn-lm btn-danger add-to-calendar" data-period="thisweek">
              </div>
            </div>
            <div class="tab-pane table-responsive" id="nextweek">
              <div class="zTable">
                <form>
                  <table class="table">
                    <thead>
                ...
                <input type="submit" value="Add to Calendar" class="btn btn-lm btn-danger add-to-calendar" data-period="nextweek">
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="modal fade" id="changeTimeZone" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form>
            <select id="timezone" class="form-control">
                              ...
                              <option value="Pacific/Pago_Pago">(UTC-11:00) Pacific/Pago Pago</option>
                              ...
                              <option value="America/Santa_Isabel">(UTC-07:00) America/Santa Isabel</option>
                              ...
                              <option value="America/Dawson_Creek">(UTC-07:00) America/Dawson Creek</option>
                              ...
                              <option value="America/El_Salvador">(UTC-06:00) America/El Salvador</option>
                              <option value="America/Boise">(UTC-06:00) America/Boise</option>
                              <option value="America/Cambridge_Bay">(UTC-06:00) America/Cambridge Bay</option>
                              ...
                              <option value="America/Costa_Rica">(UTC-06:00) America/Costa Rica</option>
                              ...
                              <option value="America/Swift_Current">(UTC-06:00) America/Swift Current</option>
                              ...
                              <option value="America/North_Dakota/New_Salem">(UTC-05:00) America/North Dakota/New Salem</option>
                              <option value="America/North_Dakota/Center">(UTC-05:00) America/North Dakota/Center</option>
                              <option value="America/North_Dakota/Beulah">(UTC-05:00) America/North Dakota/Beulah</option>
                              ...
                              <option value="America/Mexico_City">(UTC-05:00) America/Mexico City</option>
                              ...
                              <option value="America/Indiana/Tell_City">(UTC-05:00) America/Indiana/Tell City</option>
                              <option value="America/Bahia_Banderas">(UTC-05:00) America/Bahia Banderas</option>
                              <option value="America/Rio_Branco">(UTC-05:00) America/Rio Branco</option>
                              ...
                              <option value="America/Rankin_Inlet">(UTC-05:00) America/Rankin Inlet</option>
                              <option value="America/Rainy_River">(UTC-05:00) America/Rainy River</option>
                              ...
                              <option value="America/La_Paz">(UTC-04:00) America/La Paz</option>
                              ...
                              <option value="America/Grand_Turk">(UTC-04:00) America/Grand Turk</option>
                              ...
                              <option value="America/Lower_Princes">(UTC-04:00) America/Lower Princes</option>
                              ...
                              <option value="America/Thunder_Bay">(UTC-04:00) America/Thunder Bay</option>
                              <option value="America/St_Vincent">(UTC-04:00) America/St Vincent</option>
                              <option value="America/St_Thomas">(UTC-04:00) America/St Thomas</option>
                              <option value="America/St_Lucia">(UTC-04:00) America/St Lucia</option>
                              <option value="America/St_Kitts">(UTC-04:00) America/St Kitts</option>
                              <option value="America/St_Barthelemy">(UTC-04:00) America/St Barthelemy</option>
                              <option value="America/Santo_Domingo">(UTC-04:00) America/Santo Domingo</option>
                              <option value="America/Puerto_Rico">(UTC-04:00) America/Puerto Rico</option>
                              <option value="America/Cuiaba">(UTC-04:00) America/Cuiaba</option>
                              <option value="America/Port_of_Spain">(UTC-04:00) America/Port of Spain</option>
                              <option value="America/Port-au-Prince">(UTC-04:00) America/Port-au-Prince</option>
                              <option value="America/Porto_Velho">(UTC-04:00) America/Porto Velho</option>
                              ...
                              <option value="America/Cayman">(UTC-04:00) America/Cayman</option>
                              <option value="America/Campo_Grande">(UTC-04:00) America/Campo Grande</option>
                              <option value="America/Boa_Vista">(UTC-04:00) America/Boa Vista</option>
                              ...
                              <option value="America/Sao_Paulo">(UTC-03:00) America/Sao Paulo</option>
                              ...
                              <option value="America/Argentina/Rio_Gallegos">(UTC-03:00) America/Argentina/Rio Gallegos</option>
                              <option value="America/Argentina/Salta">(UTC-03:00) America/Argentina/Salta</option>
                              <option value="America/Argentina/San_Juan">(UTC-03:00) America/Argentina/San Juan</option>
                              <option value="America/Argentina/San_Luis">(UTC-03:00) America/Argentina/San Luis</option>
                              ...
                              <option value="America/Argentina/Buenos_Aires">(UTC-03:00) America/Argentina/Buenos Aires</option>
                              <option value="America/Fortaleza">(UTC-03:00) America/Fortaleza</option>
                              <option value="America/Glace_Bay">(UTC-03:00) America/Glace Bay</option>
                              <option value="America/Araguaina">(UTC-03:00) America/Araguaina</option>
                              <option value="America/Goose_Bay">(UTC-03:00) America/Goose Bay</option>
                              <option value="America/Halifax">(UTC-03:00) America/Halifax</option>
                              <option value="America/Argentina/La_Rioja">(UTC-03:00) America/Argentina/La Rioja</option>
                              <option value="America/St_Johns">(UTC-02:30) America/St Johns</option>
                              ...
                              <option value="Atlantic/South_Georgia">(UTC-02:00) Atlantic/South Georgia</option>
                              <option value="America/Miquelon">(UTC-02:00) America/Miquelon</option>
                              <option value="Atlantic/Cape_Verde">(UTC-01:00) Atlantic/Cape Verde</option>
                              ...
                              <option value="Atlantic/St_Helena">(UTC+00:00) Atlantic/St Helena</option>
                              ...
                              <option value="Africa/Sao_Tome">(UTC+00:00) Africa/Sao Tome</option>
                              ...
                              <option value="Europe/Isle_of_Man">(UTC+01:00) Europe/Isle of Man</option>
                              ...
                              <option value="Africa/El_Aaiun">(UTC+01:00) Africa/El Aaiun</option>
                              ...
                              <option value="Europe/San_Marino">(UTC+02:00) Europe/San Marino</option>
                              ...
                              <option value="Africa/Dar_es_Salaam">(UTC+03:00) Africa/Dar es Salaam</option>
                              <option value="Africa/Addis_Ababa">(UTC+03:00) Africa/Addis Ababa</option>
                              ...
                              <option value="Asia/Baku">(UTC+05:00) Asia/Baku</option>
                              ...
                              <option value="Asia/Ho_Chi_Minh">(UTC+07:00) Asia/Ho Chi Minh</option>
                              ...
                              <option value="Asia/Kuala_Lumpur">(UTC+08:00) Asia/Kuala Lumpur</option>
                              <option value="Antarctica/Casey">(UTC+08:00) Antarctica/Casey</option>
                              <option value="Asia/Hong_Kong">(UTC+08:00) Asia/Hong Kong</option>
                              ...
                              <option value="Asia/Ulaanbaatar">(UTC+09:00) Asia/Ulaanbaatar</option>
                              <option value="Asia/Seoul">(UTC+09:00) Asia/Seoul</option>
                              <option value="Asia/Choibalsan">(UTC+09:00) Asia/Choibalsan</option>
                              ...
                              <option value="Australia/Broken_Hill">(UTC+09:30) Australia/Broken Hill</option>
                              <option value="Pacific/Port_Moresby">(UTC+10:00) Pacific/Port Moresby</option>
                              ...
                              <option value="Australia/Lord_Howe">(UTC+10:30) Australia/Lord Howe</option>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" id="set-timezone">Select</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-6 col-md-7 colum-1">
        <div class="menu-footer-menu-container"><ul id="menu-footer-menu-1" class="menu"><li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-22841"><a href="../news/index.html">NEWS</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-22843"><a href="../category/market-news/fundamental-analysis/index.html">Fundamental Analysis</a></li>
	<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-22844"><a href="../category/market-news/technical-analysis/index.html">Technical Analysis</a></li>
	<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-22845"><a href="../category/industry-news/index.html">Industry News</a></li>
	<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-22846"><a href="../category/industry-news/regulator-news/index.html">Regulator News</a></li>
	<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-22847"><a href="../category/industry-news/retail-forex/index.html">Retail FX</a></li>
	<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-22848"><a href="../category/industry-news/institutional-fx/index.html">Institutional FX</a></li>
	<li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-22849"><a href="../category/guest-post/index.html">Guest Post</a></li>
</ul>
</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-22850"><a href="../directory/forex-brokers/index.html">DIRECTORY</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-23096"><a href="../directory/index.html">Forex Broker Search</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22851"><a href="../all-brokers/index.html">Forex Brokers</a></li>
</ul>
</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-22852"><a href="../forex-education/index.html">EDUCATION</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item menu-item-23047"><a href="index.html">Forex Webinars</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22853"><a href="../ebooks/index.html">Forex ebooks</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22857"><a href="../forex-education/index.html">Forex Education</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22855"><a href="../forex-glossary/index.html">Forex Glossary</a></li>
</ul>
</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-22858"><a href="../trading-tools/index.html">TOOLS</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22860"><a href="../trading-tools/forex-indicators/index.html">Trading indicators</a></li>
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22861"><a href="../trading-tools/fibonacci-calculator/index.html">Fibonacci calculator</a></li>
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22862"><a href="../trading-tools/pip-calculator/index.html">Pip calculator</a></li>
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22863"><a href="../trading-tools/pivot-calculator/index.html">Pivot Calculator</a></li>
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22864"><a href="../trading-tools/forex-signals/index.html">Free forex signals</a></li>
</ul>
</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-22865"><a href="../events/index.html">EVENTS</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-23063"><a href="../events/all-you-need-in-forex-now-on-facebook-live/index.html">Facebook Live</a></li>
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22866"><a href="../events/2016-china-forex-expo/index.html">Expos</a></li>
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22867"><a href="../events/pro-trader-challenge-2016/index.html">ProTrader Challenge</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-event menu-item-23970"><a href="../events/baltics-traders-union-2016-vilnius/index.html">Baltics traders union 2016 Vilnius</a></li>
</ul>
</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-22868"><a href="../about/index.html">ABOUT</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22869"><a href="../about/index.html">Our team</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22870"><a href="../about/advertise-us/index.html">Advertise</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22871"><a href="../about/contact-us/index.html">Contact us</a></li>
</ul>
</li>
<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-22872"><a href="#">MORE</a>
<ul class="sub-menu">
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22873"><a href="../careers/index.html">Careers</a></li>
	<li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-22874"><a href="../forums/index.html">Traders Forums</a></li>
	<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-22875"><a href="../2016-forex-awards/index.html">2016 Forex Awards</a></li>
</ul>
</li>
</ul></div>      </div>
      ...
      <div class="col-xs-12 col-md-5">
                  <a class="news-image" href="../news/8-daily-forex-trading-tips-3108/index.html" style="background-image: url('../../wp-content/uploads/2016/07/10-tips.png');"></a>
              </div>
      <div class="col-xs-12 col-md-7 np-left">
        <h3><a href="../news/8-daily-forex-trading-tips-3108/index.html">8 Daily Forex trading tips</a></h3>
        <p>Today's forex trading tips is to focus on the continued focus on USD and CAD ahead of the NFP data release on Frida...</p>
        <span class="date fl">31 August 2016</span>
        <a href="../news/8-daily-forex-trading-tips-3108/index.html" class="read-more fr"></a>
      </div>
    </div>
    <div class="clearfix"></div>
      <div class="news-item featured row">
      <div class="col-xs-12 col-md-5">
                  <a class="news-image" href="../news/you-wont-see-fed-rate-hike-in-september-and-heres-why/index.html" style="background-image: url('../../wp-content/uploads/2016/08/You-won%e2%80%99t-see-Fed-rate-hike-in-Septemeber-and-here%e2%80%99s-why-219x124.jpg');"></a>
              </div>
      <div class="col-xs-12 col-md-7 np-left">
        <h3><a href="../news/you-wont-see-fed-rate-hike-in-september-and-heres-why/index.html">You won’t see Fed rate hike in September and here’s why</a></h3>
        <p>Following hawkish Fed Stanley Fisher comments at Jackson Hole, market have increased expectations for September Fed...</p>
        <span class="date fl">30 August 2016</span>
        <a href="../news/you-wont-see-fed-rate-hike-in-september-and-heres-why/index.html" class="read-more fr"></a>
      </div>
    </div>
    <div class="clearfix"></div>
            </div>
  ...
  <form method="POST" id="form-exclusive-updates" action="#">
    ...
    <div class="input-box">
      ...
      <input type="button" class="subscribe-to-investorz" value="Submit">
        ...
        <ul class="header__soc">
          <li><a target="_blank" href="../../external.html?link=https://www.facebook.com/investorzmarkets"><i class="icon icon-facebook-h"></i></a></li>
          <li><a target="_blank" href="../../external.html?link=https://twitter.com/investorz"><i class="icon icon-twitter-h"></i></a></li>
          <li><a target="_blank" href="../../external.html?link=https://plus.google.com/+investorz/posts"><i class="icon icon-google-h"></i></a></li>
          <li><a target="_blank" href="../../external.html?link=https://www.linkedin.com/company/investorz-forex"><i class="icon icon-instagram-h"></i></a></li>
          <li><a target="_blank" href="../../external.html?link=https://www.youtube.com/channel/UC3r7Yq1x-LmCsnnWg7aA5ug"><i class="icon icon-youtube-h"></i></a></li>
        </ul>
    ...
    <div class="banner-footer ads-group">
      <div id="execphp-70" class="widget widget_execphp">			<div class="execphpwidget"><center><a href="../../external.html?link=http://www.ads-securities.co.uk/secure-broker/?utm_source=cpm&amp;utm_medium=broker-profile&amp;utm_campaign=2015-q4-investorz&amp;cmp=investorz" target="_blank"><img src="../../wp-content/uploads/2016/08/spreadsB_aug_550x90_en.jpg" width="700" height="114"></a></center></div>		</div>    </div>
    <!--end banner-->
  </div>
          ...
          <div class="mail">
            <div class="row">
              <div class="col-md-6">
                ...
                <a href="../cdn-cgi/l/email-protection.html#85ecebe3eac5e4f1eaffe3eaf7e0fdabe6eae8">info@investorz.com</a>
                <div class="sth">
                  <iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" class="twitter-follow-button twitter-follow-button-rendered" title="Twitter Follow Button" src="https://platform.twitter.com/widgets/follow_button.cc55ce010cf84cc9f5752aec264d23e3.en.html#dnt=false&amp;id=twitter-widget-0&amp;lang=en&amp;screen_name=investorz&amp;show_count=true&amp;show_screen_name=false&amp;size=m&amp;time=1473701686337" style="position: static; visibility: visible; width: 152px; height: 20px;" data-screen-name="investorz"></iframe>
                  <div class="fb-like" data-href="https://www.facebook.com/investorzmarkets" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="false"></div>
                </div>
              </div>
              <div class="col-md-6">
                <span class="copy">Copyright © 2016 investorzFX. All Rights Reserved.</span>
                                <span class="terms">
                                      <a href="../terms-and-conditions/index.html">Terms &amp; Conditions</a>
                                      <a href="../terms-and-conditions/index.html">Risk Disclaimer</a>
...
<script type="text/javascript">
/* <![CDATA[ */
var pollsL10n = {"ajax_url":"http:\/\/investorz.com\/wp-admin\/admin-ajax.php","text_wait":"Your last request is still being processed. Please wait a while ...","text_valid":"Please choose a valid poll answer.","text_multiple":"Maximum number of choices allowed: ","show_loading":"1","show_fading":"1"};
/* ]]> */
</script>
<script type="text/javascript" src="../../wp-content/plugins/bwp-minify/min/index12fb.html"></script>
<script type="text/javascript" src="../../wp-content/plugins/bwp-minify/min/indexb2f8.html"></script>
<script type="text/javascript" src="../../wp-content/plugins/bwp-minify/min/index604c.html"></script>
<script type="text/javascript" src="../../wp-content/plugins/bwp-minify/min/index957f.html"></script>
